...
SPN - HOST/domain.local.com
В данном случае агрегат HOST - это различные сервисы (cifs, http, ldap)

Если разрешить доступ к одному сервису, то и к другому будет, так как TGS шифруется на секрете учетной записи сервиса