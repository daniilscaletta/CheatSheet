...
1) **Внесение изменений в сервисы и внешние программы в ОС**
**Примеры:**
...
1) **Внесение изменений в ядро ОС и в предустановленные службы на нем**
**Примеры:**
- **Rootkit** ([TripleCross](https://github.com/h3xduck/TripleCross))
- [RAT](https://github.com/n1nj4sec/pupy)

1) **Внедрение бэкдоров аутентификации на основе PAM**
