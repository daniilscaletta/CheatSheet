...
**Пассивная разведка**
1) **SecurityTrails**  -  MUSTHAVE
2) dnsdumpster - поиск информации о домене: нахождение доменов, почтовых серверов и dns серверов
3) crt.sh - поиск выпущенных сертификатов на доменное имя
4) censys.io
5) pentest-tools.com
6) shodan.io

> **Shodan → Censys → SecurityTrails → crt.sh → VirusTotal → DNSDumpster → urlscan.io → Amass/Subfinder** - CHAIN
